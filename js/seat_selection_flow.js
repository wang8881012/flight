        ...
        nextBtn.addEventListener('click', () => {
            ...
            allSelections.push({
                ...
                outbound: {
                    seat: outboundSeat,
                    meal: outboundMeal,
                    baggage: { weight: outboundBaggageWeight, price: outboundBaggagePrice }
                },
                return: {
                    seat: returnSeat,
                    meal: returnMeal,
            ...
            if (currentPassengerIndex > passengerCount) {
                ...
                const bsCollapse = bootstrap.Collapse.getOrCreateInstance(outboundCollapse);
                bsCollapse.show();
...
function updateAllCanvas() {
    ...
    for (const trip of tripTypes) {
        ...
        if (ctx && window.drawCanvasWithOverlay) {
            window.drawCanvasWithOverlay(trip, ctx, canvas.width, canvas.height, currentPassengerIndex);
        }
    }
}
