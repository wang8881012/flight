...
document.getElementById("nextPageBtn").addEventListener("click", async () => {
  ...
  if (tripType === "round") {
    ...
    baseParams.departure1 = document.getElementById(
      "departureCityRound1"
    ).value;
    baseParams.arrival1 = document.getElementById("arrivalCityRound1").value;
    baseParams.departure2 = document.getElementById(
      "departureCityRound2"
    ).value;
    baseParams.arrival2 = document.getElementById("arrivalCityRound2").value;
    if (
      baseParams.departure1 === baseParams.arrival1 ||
      baseParams.departure2 === baseParams.arrival2
    ) {
      alert("出發地與目的地不可相同");
      return;
    }
